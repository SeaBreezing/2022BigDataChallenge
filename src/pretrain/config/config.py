...
def parse_args():
    ...
    # ========================= Data Configs ==========================
    # parser.add_argument('--train_annotation', type=str, default='../../../autodl-tmp/annotations/unlabeled.json')
    ...
    # parser.add_argument('--test_zip_feats', type=str, default='../../../autodl-tmp/zip_feats/untest_b.zip')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='../save/pretrain.pth')
    parser.add_argument('--ckpt_file', type=str, default='../save/baselinev2-tricks/model_.bin')
    parser.add_argument('--best_score', default=0.64, type=float, help='save checkpoint if mean_f1 > best_score')
